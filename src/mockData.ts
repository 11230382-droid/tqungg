...
export const posts: Post[] = [
  {
    ...
    user: {
      ...
      followers: '0', following: '0', itemCount: '0', totalValue: '0'
    },
    ...
    caption: 'Finally secured the 1/6 scale Vanguard Unit. The articulation on this piece is absolutely insane. Worth the 8-month wait!',
  ...
  },
  {
    ...
    caption: 'Just hit the local flea market and found these gems from \'85.',
